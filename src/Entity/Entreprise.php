...
class Entreprise
{
    ...
    #[ORM\OrderBy(["nom" => "ASC"])]
    // trier les employé de l'entreprise dans l'ordre alphabétique
    ...
    // Pour afficher date | ne pas faire , on ne modifie pas le getter 
    ...
    public function getAdresseComplète()
    {
    ...
    // Pour ne pas avoir à concaténer
